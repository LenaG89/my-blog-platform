...
import {useUpdateAnArticleMutation} from '../../store/kataPostsApi'
...
const EditArticlePage = ()=>{
    ...
    return (
        <div className={stl.content}>
          <ArticleForm formTitle='Edit article' slug={slug} handleOnSubmit={handleOnSubmit} isError={isError} error={error}/>
        </div>
      );
}
